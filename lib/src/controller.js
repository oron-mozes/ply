...
function init() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var user, argv, getYarnAction, getNpmAction, getPackageManager, interpretCommand, startTime, _b, internalFlags, executionCommand, packageManager, action, executionProcess, pkg, user_1, projectData, pathToGame;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    console.log('???????????????');
                    return [4 /*yield*/, (0, services_1.signupUser)()];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, (0, services_1.saveData)()];
                case 2:
                    _c.sent();
                    _c.label = 3;
                case 3:
                ...
                case 4:
                    startTime = Date.now();
                    _b = interpretCommand(argv), internalFlags = _b.internalFlags, executionCommand = _b.executionCommand, packageManager = _b.packageManager, action = _b.action;
                    executionProcess = (0, shelljs_1.exec)(executionCommand, { async: true });
                    pkg = (0, read_package_json_1.getPackageJson)();
                    user_1 = (0, services_1.getUserData)();
                    return [4 /*yield*/, axios_1.default.get("".concat(consts_1.apiBaseUrl, "/project?name=").concat(pkg.name, "&userId=").concat(user_1.id, "&action=").concat(action))];
                case 5:
                    projectData = (_c.sent()).data;
