...
function saveUserFile() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, rootDirectory, userFileName, serverUrl, configFileName, email, placeOfWork, sound, data, setupPly;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, inquirer_1.default.prompt({
                            name: "email",
                            message: "".concat(chalk_1.default.blue("Congrats and hope you will like \"ply-cli\"."), "\n").concat(chalk_1.default.green("This message appears only because this is the first time you used the \"ply\" command.\nBecacuse this is your first time we would like to get some information in order to create the best service for you. In order to sign you up we need to know what is your email?")),
                ...
                case 4:
                    data = (_b.sent()).data;
                    setupPly = { sound: sound, ambianceSound: false };
                    return [4 /*yield*/, Promise.all([
                            fs_1.default.writeFileSync("".concat(rootDirectory).concat(userFileName), JSON.stringify({ "id": data.id })), fs_1.default.writeFileSync("".concat(rootDirectory).concat(configFileName), JSON.stringify(setupPly))
                        ])];
                case 5:
                    _b.sent();
                    return [2 /*return*/];
