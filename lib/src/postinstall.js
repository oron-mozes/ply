            ...
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.all([
                            fs_1.default.writeFileSync("".concat(rootDirectory).concat(userFileName), JSON.stringify({ "id": data.id })), fs_1.default.writeFileSync("".concat(rootDirectory).concat(configFileName), JSON.stringify({ sound: sound }))
                        ])];
                case 5:
                    _b.sent();
                    return [2 /*return*/];
